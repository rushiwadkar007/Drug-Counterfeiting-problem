...
echo "Updating anchor peers for SUNPHARMA..."
updateAnchorPeers 0 'sunpharma'
echo "Updating anchor peers for VGPHARMA..."
updateAnchorPeers 0 'vgpharma'
echo "Updating anchor peers for UpGrad..."
updateAnchorPeers 0 'upgrad'
echo "Updating anchor peers for FEDEX..."
updateAnchorPeers 0 'fedex'
echo "Updating anchor peers for PIONEERATLANTIC..."
updateAnchorPeers 0 'pioneeratlantic'
